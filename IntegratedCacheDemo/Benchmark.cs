...
namespace IntegratedCacheDemo
{
    ...
    public class Benchmark
    {
        ...
        private static void OutputResults(Benchmark benchmark, List<Result> results)
        {
            ...
            benchmark.resultSummary = new ResultSummary(benchmarkType, benchmark.testName, averageLatency, averageRu);

            Console.WriteLine($"\nSummary\n");
            Console.WriteLine($"Test {results.Count} {benchmarkType} {testName}\n");
